...
if __name__ == "__main__":
    ...
    Result = pd.DataFrame()
    Correlation = [-0.5,-.25,0,0.25,0.5,0.75,1.0]
    if Result.empty:
    ...
    for corr in Correlation:
        ...
        for _ in range(5):
            ...
            SYN_data = DataGen(0.25,corr,20,policies,v_dim)
        ...
        print ("Final Prediction MSE DR",MSE_score_DR/5.0)
        print ("Final Prediction MSE RA",MSE_score_RA/5.0)
        print ("Final Prediction MSE SP",MSE_score_SP/5.0)
        DR_result.append(MSE_score_DR/5.0)
        RA_result.append(MSE_score_RA/5.0)
        SP_result.append(MSE_score_SP/5.0)

    Result['DR'] = DR_result
    Result['RA'] = RA_result
    Result['SP'] = SP_result
        #Result[algo] = result_MSE_Pred
    Result.to_csv(f"CorrEffect_algo.csv")
